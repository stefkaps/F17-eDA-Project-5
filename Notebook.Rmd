...
```{r}
# Logistic Regression
glm.fit.region=glm(region_binary~yll_rate_ui_upto+daly_rate_ui_upto+yld_abs_ui_from+daly_abs_ui_from+yld_rate_ui_upto,data=df_region,family=binomial,subset=train_region)
summary(glm.fit.region)
glm.probs=predict(glm.fit.region,newdata=df_test_region[test_region,],type="response")
glm.pred=ifelse(glm.probs>0.5,"1","0")
region.test = df_test_region[test_region,]$region_binary
